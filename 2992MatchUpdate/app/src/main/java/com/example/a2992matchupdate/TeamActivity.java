...
public class TeamActivity extends AppCompatActivity {
    ...
    public static String currMatchNum;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!(bundleExtras == null)){
            ...
            currMatchNum = bundleExtras.getString("matchNum");
        } else {
        ...
        toolbarTeamText.setText("    "  + teamNum);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            Intent intent = new Intent(TeamActivity.this, LaunchActivity.class);
            intent.putExtra("matchNum", currMatchNum);
